...
description: Diagnose CDR precompile failures — OOG, ReentrancySentryOOG, AlreadyConfigured, unconfigured uuid, missing initWasm, partial-collection timeout. Use when a CDR transaction reverts or a read hangs.
license: MIT
---
