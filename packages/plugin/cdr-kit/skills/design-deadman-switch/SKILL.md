...
description: Design a Story CDR DeadManSwitchCondition vault — auto-unlock-to-heir-or-public if the creator stops poke()-ing. Wallet recovery, estate planning, leak-on-disappearance, journalist-dead-drop. Use this skill whenever the user mentions dead man switch, dead-man's switch, deadman, deadmanswitch, heartbeat, leak-on-disappearance, wallet recovery, estate planning, journalist trapdoor, posthumous unlock, "what happens if I stop responding", "auto-publish after N days of silence".
license: MIT
---
