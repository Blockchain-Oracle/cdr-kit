...
description: Audit an existing CDR vault — verify its read/write conditions, condition data, owner, and license terms match the intended design. Use when reviewing someone else's vault before subscribing, or auditing your own deployment.
license: MIT
---
