...
description: Pick the right CDR access-control condition (open / subscription / tier-gate / composable / license) for the use case. Use when designing a new CDR vault or evaluating an existing one's read/write conditions.
license: MIT
---
